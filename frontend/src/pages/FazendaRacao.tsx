...
// import { preverProducao } from './FazendaRacao/services/productionForecaster'
...
//       {/* 🚨 Painel de Alertas da Fazenda */}
//       {(() => {
//         // Coletar todos os alertas da fazenda
//         const todosAlertas = dashboard.viveiros.flatMap(viveiro => {
//           const hoje = new Date().toISOString().split('T')[0];
//           const racaoHoje = viveiro.racoes.find(r => normalizeDate(r.data) === hoje);
...
//           if (percentualRecomendado < 50 && viveiro.doc > 15) {
//             alertas.push({
//               tipo: 'critico',
//               viveiro: viveiro.viveiro.nome,
//               titulo: 'Subalimentação Crítica',
//               descricao: `${percentualRecomendado.toFixed(0)}% da ração recomendada`
//             });
//           }
          
//           if (viveiro.fcrAtual > 2.0 && viveiro.doc > 30) {
//             alertas.push({
//               tipo: 'atencao',
//               viveiro: viveiro.viveiro.nome,
//               titulo: 'FCR Elevado',
//               descricao: `FCR: ${viveiro.fcrAtual.toFixed(2)}`
//             });
//           }
          
//           if (viveiro.biomassa < (viveiro.doc * 0.5) && viveiro.doc > 20) {
//             alertas.push({
//               tipo: 'atencao',
//               viveiro: viveiro.viveiro.nome,
//               titulo: 'Biomassa Abaixo',
//               descricao: `${viveiro.biomassa.toFixed(1)}kg vs ${(viveiro.doc * 0.5).toFixed(1)}kg esperado`
//             });
//           }
...
//         const alertasCriticos = todosAlertas.filter(a => a.tipo === 'critico').length;
//         const alertasAtencao = todosAlertas.filter(a => a.tipo === 'atencao').length;

//         if (todosAlertas.length > 0) {
//           return (
//             <div className="fazenda-alertas-painel">
//               <div className="fazenda-alertas-painel-header">
//                 <span className="fazenda-alertas-painel-title">🚨 Alertas da Fazenda</span>
//                 <span className="fazenda-alertas-painel-total">{todosAlertas.length} alertas</span>
//               </div>
              
//               <div className="fazenda-alertas-resumo">
//                 <div className="fazenda-alerta-resumo-item critico">
//                   <span className="fazenda-alerta-resumo-numero">{alertasCriticos}</span>
//                   <span className="fazenda-alerta-resumo-texto">Críticos</span>
//                 </div>
//                 <div className="fazenda-alerta-resumo-item atencao">
//                   <span className="fazenda-alerta-resumo-numero">{alertasAtencao}</span>
//                   <span className="fazenda-alerta-resumo-texto">Atenção</span>
//                 </div>
//                 <div className="fazenda-alerta-resumo-item total">
//                   <span className="fazenda-alerta-resumo-numero">{todosAlertas.length}</span>
//                   <span className="fazenda-alerta-resumo-texto">Total</span>
//                 </div>
//               </div>

//               <div className="fazenda-alertas-lista">
//                 {todosAlertas.slice(0, 5).map((alerta, index) => (
//                   <div key={index} className={`fazenda-alerta-item ${alerta.tipo}`}>
//                     <div className="fazenda-alerta-viveiro">{alerta.viveiro}</div>
//                     <div className="fazenda-alerta-conteudo">
//                       <div className="fazenda-alerta-titulo">{alerta.titulo}</div>
//                       <div className="fazenda-alerta-descricao">{alerta.descricao}</div>
//                     </div>
//                   </div>
//                 ))}
//                 {todosAlertas.length > 5 && (
//                   <div className="fazenda-alertas-mais">
//                     +{todosAlertas.length - 5} mais alertas nos viveiros
//                   </div>
//                 )}
//               </div>
//             </div>
...
//             // 🚨 ALERTAS AUTOMÁTICOS COM INFORMAÇÕES REAIS
//             const alertas = [];
            
//             // 1. Alerta de subalimentação crítica
//             if (percentualRecomendado < 50 && viveiro.doc > 15) {
//               alertas.push({
//                 tipo: 'critico',
//                 titulo: '⚠️ Subalimentação Crítica',
//                 descricao: `Apenas ${percentualRecomendado.toFixed(0)}% da ração recomendada. Viveiro com ${viveiro.doc} dias precisa de atenção imediata.`,
//                 acao: 'Aumentar ração imediatamente'
//               });
//             }
            
//             // 2. Alerta de excesso de ração
//             if (percentualRecomendado > 120) {
//               alertas.push({
//                 tipo: 'atencao',
//                 titulo: '🚨 Excesso de Ração',
//                 descricao: `${percentualRecomendado.toFixed(0)}% da recomendação. Risco de desperdício e poluição da água.`,
//                 acao: 'Reduzir quantidade'
//               });
//             }
            
//             // 3. Alerta de FCR elevado
//             if (viveiro.fcrAtual > 2.0 && viveiro.doc > 30) {
//               alertas.push({
//                 tipo: 'atencao',
//                 titulo: '📊 FCR Elevado',
//                 descricao: `FCR atual: ${viveiro.fcrAtual.toFixed(2)}. Eficiência alimentar abaixo do ideal.`,
//                 acao: 'Revisar estratégia alimentar'
//               });
//             }
            
//             // 4. Alerta de baixa biomassa para fase
//             if (viveiro.biomassa < (viveiro.doc * 0.5) && viveiro.doc > 20) {
//               alertas.push({
//                 tipo: 'atencao',
//                 titulo: '📉 Biomassa Abaixo do Esperado',
//                 descricao: `Biomassa atual: ${viveiro.biomassa.toFixed(1)}kg. Esperado para ${viveiro.doc} dias: ${(viveiro.doc * 0.5).toFixed(1)}kg.`,
//                 acao: 'Verificar parâmetros de qualidade'
//               });
//             }
            
//             // 5. Alerta de inconsistência de consumo
//             const ultimos3dias = viveiro.racoes.slice(-3);
//             if (ultimos3dias.length >= 3) {
//               const mediaConsumo = ultimos3dias.reduce((sum, r) => sum + r.total, 0) / ultimos3dias.length;
//               const variacao = Math.abs((ultimos3dias[2].total - mediaConsumo) / mediaConsumo) * 100;
              
//               if (variacao > 30) {
//                 alertas.push({
//                   tipo: 'info',
//                   titulo: '📊 Variação Inconsistente',
//                   descricao: `Variação de ${variacao.toFixed(0)}% no consumo nos últimos 3 dias. Pode indicar estresse ou qualidade da água.`,
//                   acao: 'Monitorar parâmetros'
//                 });
//               }
//             }
            
//             // 6. Alerta de fase crítica de crescimento
//             if (viveiro.doc >= 25 && viveiro.doc <= 35 && percentualRecomendado < 80) {
//               alertas.push({
//                 tipo: 'importante',
//                 titulo: '🌱 Fase Crítica de Crescimento',
//                 descricao: `Viveiro em fase de crescimento acelerado (${viveiro.doc} dias). Necessário ${percentualRecomendado.toFixed(0)}% da ração para máximo desenvolvimento.`,
//                 acao: 'Garantir alimentação completa'
//               });
//             }
            
//             // 7. Alerta de proximidade de despesca
//             if (viveiro.doc >= 100 && viveiro.doc <= 110) {
//               alertas.push({
//                 tipo: 'info',
//                 titulo: '🎯 Próximo da Despesca',
//                 descricao: `Faltam ${120 - viveiro.doc} dias para despesca. Otimizar alimentação para máximo peso.`,
//                 acao: 'Focar em engorda'
//               });
//             }
            
//             // 8. Alerta de ração acumulada elevada
//             if (viveiro.racaoAcumulada > 0 && viveiro.biomassa > 0) {
//               const eficienciaAcumulada = viveiro.biomassa / viveiro.racaoAcumulada;
//               if (eficienciaAcumulada < 0.4) {
//                 alertas.push({
//                   tipo: 'atencao',
//                   titulo: '📉 Eficiência Acumulada Baixa',
//                   descricao: `Eficiência acumulada: ${(eficienciaAcumulada * 100).toFixed(1)}%. Abaixo do ideal para produção sustentável.`,
//                   acao: 'Revisar práticas de manejo'
//                 });
//               }
//             }
            
//             // 9. Alerta de horário inadequado
//             const horaAtual = new Date().getHours();
//             if (horaAtual >= 14 && horaAtual <= 16 && !alimentouTarde && viveiro.doc > 20) {
//               alertas.push({
//                 tipo: 'info',
//                 titulo: '⏰ Horário de Alimentação',
//                 descricao: 'Período ideal para alimentação da tarde. Camarões mais ativos neste horário.',
//                 acao: 'Realizar alimentação tarde'
//               });
//             }
            
//             // 10. Alerta de previsão de aumento significativo
//             if (previsaoAmanha.tendencia === 'aumento' && (previsaoAmanha.racaoHoje / viveiro.recomendadoTotal) > 1.15) {
//               alertas.push({
//                 tipo: 'info',
//                 titulo: '📈 Aumento Previsto',
//                 descricao: `Aumento de ${((previsaoAmanha.racaoHoje / viveiro.recomendadoTotal - 1) * 100).toFixed(0)}% previsto para amanhã devido ao crescimento.`,
//                 acao: 'Preparar aumento de ração'
//               });
//             }
...
//                       <span className="fazenda-alerts-title">🚨 Alertas Automáticos</span>
//                       <span className="fazenda-alerts-count">{alertas.length}</span>
//                     </div>
//                     {alertas.map((alerta, index) => (
//                       <div key={index} className={`fazenda-alert-item ${alerta.tipo}`}>
//                         <div className="fazenda-alert-header">
//                           <span className="fazenda-alert-titulo">{alerta.titulo}</span>
//                           <span className={`fazenda-alert-badge ${alerta.tipo}`}>
//                             {alerta.tipo === 'critico' ? '🔴 Crítico' : 
//                              alerta.tipo === 'atencao' ? '🟡 Atenção' :
//                              alerta.tipo === 'importante' ? '🟠 Importante' : '🔵 Info'}
//                           </span>
//                         </div>
//                         <div className="fazenda-alert-descricao">{alerta.descricao}</div>
//                         <div className="fazenda-alert-acao">
...
//                 {/* Anomalias Detectadas (mantido para compatibilidade) */}
//                 {anomalias.length > 0 && alertas.length === 0 && (
//                   <div className="fazenda-viveiro-alerts">
//                     <div className="fazenda-alerts-header">
//                       <span className="fazenda-alerts-title">⚠️ Anomalias Detectadas</span>
//                     </div>
...
//                       <span className="fazenda-producao-value">{(previsaoProducao.producaoEstimada)} kg</span>
//                     </div>
//                     <div className="fazenda-producao-item">
