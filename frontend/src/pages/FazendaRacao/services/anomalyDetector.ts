import { ViveiroDashboard, Anomalia } from '../types/dashboard';

/**
 * Detecta anomalias no comportamento do viveiro
 * @param viveiro - Dados do viveiro para análise
 * @returns Lista de anomalias detectadas
 */
export const detectarAnomalias = (viveiro: ViveiroDashboard): Anomalia[] => {
